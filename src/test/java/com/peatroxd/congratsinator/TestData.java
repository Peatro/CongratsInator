...
public class TestData {
    ...
    public static final String PHOTO_URL = "http://example.com/photos/photo_key_123.jpg";
    public static final String PERSON_NAME = "John Doe";
    public static final String NOTIFICATION_EMAIL_SUBJECT = "Upcoming Birthdays";
    public static final String NOTIFICATION_EMAIL_BODY = "Hello there";
    ...
    public static PersonDto dtoFrom(Person person) {
